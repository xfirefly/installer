...
Name: "{group}\蓝莓投屏"; Filename: "{app}\wincast.exe";  WorkingDir: "{app}"; IconFilename: "app.ico"; Comment: "蓝莓投屏"
Name: "{commondesktop}\蓝莓投屏"; Filename: {app}\wincast.exe; WorkingDir: {app}; IconFilename: "app.ico"; Comment: "蓝莓投屏" 
